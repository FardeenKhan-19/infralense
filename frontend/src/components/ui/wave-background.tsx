...
export function Waves({
    className = "",
    strokeColor = "rgba(0, 245, 255, 0.3)",  // Cyan-ish lines for Infralense
    backgroundColor = "transparent",  // Transparent to layer over grid
    pointerSize = 0.5
}: WavesProps) {
    ...
    const setLines = () => {
        ...
        const xGap = 12  // Slightly increased for performance while maintaining smoothness
        const yGap = 12
